...
import { activateOwnMembership } from '../lib/teamApi'
  ...
  return (
    <div style={styles.page}>
      ...
      <form style={styles.card} onSubmit={handleSubmit}>
        <h2 style={styles.title}>Willkommen im Team</h2>
        <p style={styles.subtitle}>Leg ein Passwort fest, um deine Einladung anzunehmen.</p>
        ...
        <button type="submit" className="btn btn-primary" style={{ width: '100%', justifyContent: 'center' }} disabled={submitting}>
          {submitting ? 'Wird gespeichert …' : 'Passwort speichern & loslegen'}
        </button>
      </form>
    </div>
  )
